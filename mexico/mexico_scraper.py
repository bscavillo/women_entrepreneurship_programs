...
def validate(panel: pd.DataFrame, processed_quarters) -> None:
    ...
    notes = [
        ("PSTS sector definition (scian == 12)",
         "The ENOE/ENOE-N variable `scian` groups economic activity into 21 SCIAN "
         "sectors. Code 12 = 'Servicios profesionales, científicos y técnicos', the "
         "exact equivalent of US NAICS 54. The coding is identical across the old "
         "ENOE (2014–2020 Q1), ENOE N (2020 Q3–2022) and current ENOE (2023+), so the "
         "PSTS series is comparable across the whole panel."),
        ("Analysis universe",
         "All tabulations apply INEGI's standard universe before weighting: "
         "R_DEF=0 (complete interview), C_RES in {1,3} (usual resident), age 15–98. "
         "This reproduces INEGI's published labor-force totals."),
        ("ETOE 2020 Q2 (May/June/August)",
         "Telephone substitute during COVID-19. The CSV files are no longer served; "
         "the DBF releases contain only a household roster (no employment variables "
         "or expansion weight), so 2020 Q2 could not be incorporated. The 2020 annual "
         "figure is the mean of Q1, Q3 and Q4."),
        ("Survey-design breaks",
         "Two methodological breaks exist: old ENOE → ENOE N (2020 Q3, new sample "
